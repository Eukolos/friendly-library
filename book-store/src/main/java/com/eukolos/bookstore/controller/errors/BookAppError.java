...
public class BookAppError {

    private final String apiVersion;
    private final ErrorBlock error;

    public BookAppError(final String apiVersion, final String code, final String message, final String domain,
    ...
    public static BookAppError fromDefaultAttributeMap(final String apiVersion,
